...
task main()
{
	...
	{
		if (irSeeker.acValues[2] > 90)
		{
			pos = 3;
		}
		else if (irSeeker.acValues[2] > 3)
		{
			pos = 2;
		}
		moveStraight(83, 30); // check the cm distances :)
		wait10Msec(200);
	}
	switch(pos)
	{
		case 1: //need to test the route values
		...
		moveSpin(-50, 1.4);//power, radiance
		moveStraight(20, 50);
		moveSpin(50, 1.2);//power, radiance
		moveStraight(150, 50);
		wait10Msec(6000);
		break;
	}
